...
envelopes_queue_send_name = "envelopes-queue-send-connection-string-premium"
envelopes_queue_listen_name = "envelopes-queue-listen-connection-string-premium"
envelopes_queue_max_delivery_count_name = "envelopes-queue-max-delivery-count-premium"
processed_envelopes_queue_send_name = "processed-envelopes-queue-send-connection-string-premium"
processed_envelopes_queue_listen_name = "processed-envelopes-queue-listen-connection-string-premium"
payments_queue_send_name = "payments-queue-send-connection-string-premium"
payments_queue_listen_name = "payments-queue-listen-connection-string-premium"