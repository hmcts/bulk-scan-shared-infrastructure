...
WHERE id != 640 AND email = 'bulkscan+ccd@gmail.com';
...
VALUES
  (640, false, 'https://localhost:9000/poc/ccd', 'Bulkscan', 'Caseworker', 0, 'bulkscan+ccd@gmail.com',
        '$2a$11$jAm0yVSENaUkeqTbN6HUeePBeHFr4eGCy1FGt9URv0MkfaqihA96O',
